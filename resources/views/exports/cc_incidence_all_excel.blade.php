    ...
    <tbody>
        @forelse($rows as $index => $row)
            <tr>
                ...
                <td style="padding:6px; text-align:right; background:{{ $index % 2 == 0 ? '#edf4fb' : '#e8f1fb' }};">
                    {{ number_format($row->patient_cc_total ?? 0) }}
                </td>
                <td style="padding:6px; text-align:right; background:{{ $index % 2 == 0 ? '#edf4fb' : '#e8f1fb' }};">
                ...
                <td style="padding:6px; text-align:right;">{{ number_format($row->patient_cc_total1 ?? 0) }}</td>
                ...
                <td style="padding:6px; text-align:right;">{{ number_format($row->patient_cc_total2 ?? 0) }}</td>
                ...
                <td style="padding:6px; text-align:right;">{{ number_format($row->patient_cc_total3 ?? 0) }}</td>
                ...
                <td style="padding:6px; text-align:right;">{{ number_format($row->patient_cc_total4 ?? 0) }}</td>
                ...
                <td style="padding:6px; text-align:right;">{{ number_format($row->patient_cc_total5 ?? 0) }}</td>
        ...
        <tr>
            ...
            <td style="padding:7px; text-align:right; font-weight:bold; background:#eaf2fb;">{{ number_format($summary->patient_cc_total_sum ?? 0) }}</td>
