...
<head>
    ...
    <title>อัตราการป่วยด้วยโรคหลอดเลือดสมอง</title>
    ...
    <div class="ga-page shadow-soft">
        ...
        <div class="ga-topbar">
            <div class="ga-title">
                ...
                <span>อัตราการป่วยด้วยโรคหลอดเลือดสมอง</span>
            </div>
            ...
            <form method="GET" id="filterForm">
                <div class="row g-3 align-items-end">
                 ...
                 <div class="ga-filter-actions">
                    ...
                    <a href="{{ route('health.stroke-incidence-all.export', request()->query()) }}" class="btn ga-btn-export">
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-md-4">
                <div class="ga-kpi">
                    ...
                    <h3 class="ga-kpi-value">{{ number_format($summary->patient_stroke_total_sum ?? 0) }}</h3>
                </div>
            </div>
            <div class="col-md-4">
                <div class="ga-kpi">
                    ...
                    <tbody>
                        @forelse($rows as $row)
                            <tr>
                                ...
                                <td class="text-end metric-blue">{{ number_format($row->patient_stroke_total) }}</td>
                        ...
                        <tr class="ga-total-row">
                            ...
                            <td class="text-end">{{ number_format($summary->patient_stroke_total_sum ?? 0) }}</td>
        ...
        <div class="ga-legend-box">
            ...
            <div class="ga-legend-item">
                <strong>A</strong> หมายถึง จำนวนผู้ป่วยด้วยโรคหลอดเลือดสมองทั้งหมด
            </div>
