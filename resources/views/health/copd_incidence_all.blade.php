...
<head>
    ...
    <title>อัตราการป่วยด้วยโรคปอดอุดกั้นเรื้อรัง</title>
    ...
    <div class="ga-page shadow-soft">
        ...
        <div class="ga-topbar">
            <div class="ga-title">
                ...
                <span>อัตราการป่วยด้วยโรคปอดอุดกั้นเรื้อรัง</span>
            </div>
            ...
            <form method="GET" id="filterForm">
                <div class="row g-3 align-items-end">
                 ...
                 <div class="ga-filter-actions">
                    ...
                    <a href="{{ route('health.copd-incidence-all.export', request()->query()) }}" class="btn ga-btn-export">
        ...
        <div class="ga-legend-box">
            ...
            <div class="ga-legend-item">
                <strong>A</strong> หมายถึง จำนวนผู้ป่วยด้วยโรคปอดอุดกั้นเรื้อรังทั้งหมด
            </div>
