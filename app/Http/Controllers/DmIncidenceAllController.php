...
use App\Exports\DmIncidenceAllExport;

class DmIncidenceAllController extends Controller
{
    public function index(Request $request)
    {
        ...
        $rows = $conn->table($table)
            ...
            ->selectRaw("
                ...
                CASE
                    ...
                    ELSE (SUM(IFNULL(patient_dm_total, 0)) * 100.0) / SUM(IFNULL(population_total, 0))
                ...
                CASE
                    ...
                    ELSE (SUM(IFNULL(patient_dm_total1, 0)) * 100.0) / SUM(IFNULL(population_total1, 0))
                ...
                CASE
                    ...
                    ELSE (SUM(IFNULL(patient_dm_total2, 0)) * 100.0) / SUM(IFNULL(population_total2, 0))
                ...
                CASE
                    ...
                    ELSE (SUM(IFNULL(patient_dm_total3, 0)) * 100.0) / SUM(IFNULL(population_total3, 0))
                ...
                CASE
                    ...
                    ELSE (SUM(IFNULL(patient_dm_total4, 0)) * 100.0) / SUM(IFNULL(population_total4, 0))
                ...
                CASE
                    ...
                    ELSE (SUM(IFNULL(patient_dm_total5, 0)) * 100.0) / SUM(IFNULL(population_total5, 0))
        ...
        $overallRate = $summary->population_total_sum > 0
            ? (($summary->patient_dm_total_sum * 100) / $summary->population_total_sum)
            : 0;

        return view('health.dm_incidence_all', compact(
            'rows',
            'summary',
            'districtList',
            'yearList',
    ...
    public function export(Request $request)
    {
        ...
        return Excel::download(
            new DmIncidenceAllExport($request),
            'อัตราการป่วยด้วยโรคเบาหวาน' . $year . '.xlsx'
        );
    }
}