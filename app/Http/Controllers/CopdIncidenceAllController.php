...
use App\Exports\CopdIncidenceAllExport;

class CopdIncidenceAllController extends Controller
{
    public function index(Request $request)
    {
        ...
        $table = 'health_copd_incidence_all';
        ...
        $rows = $conn->table($table)
            ...
            ->selectRaw("
                ...
                CASE
                    ...
                    ELSE (SUM(IFNULL(patient_copd_total, 0)) * 100.0) / SUM(IFNULL(population_total, 0))
                ...
                CASE
                    ...
                    ELSE (SUM(IFNULL(patient_copd_total1, 0)) * 100.0) / SUM(IFNULL(population_total1, 0))
                ...
                CASE
                    ...
                    ELSE (SUM(IFNULL(patient_copd_total2, 0)) * 100.0) / SUM(IFNULL(population_total2, 0))
                ...
                CASE
                    ...
                    ELSE (SUM(IFNULL(patient_copd_total3, 0)) * 100.0) / SUM(IFNULL(population_total3, 0))
                ...
                CASE
                    ...
                    ELSE (SUM(IFNULL(patient_copd_total4, 0)) * 100.0) / SUM(IFNULL(population_total4, 0))
                ...
                CASE
                    ...
                    ELSE (SUM(IFNULL(patient_copd_total5, 0)) * 100.0) / SUM(IFNULL(population_total5, 0))
        ...
        $overallRate = $summary->population_total_sum > 0
            ? (($summary->patient_copd_total_sum * 100) / $summary->population_total_sum)
            : 0;

        return view('health.copd_incidence_all', compact(
            'rows',
            'summary',
            'districtList',
            'yearList',
    ...
    public function export(Request $request)
    {
        ...
        return Excel::download(
            new CopdIncidenceAllExport($request),
            'อัตราการป่วยด้วยโรคปอดอุดกั้นเรื้อรัง' . $year . '.xlsx'
        );
    }
}