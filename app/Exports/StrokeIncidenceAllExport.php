...
class StrokeIncidenceAllExport implements FromView, ShouldAutoSize
{
        ...
        if ($year !== '') {
            $rows = DB::connection('mysql_help')
                ...
                ->select(
                    'district_name_thai',
                    'population_total',
                    'patient_stroke_total',
                    'percentage_total',
                    'population_total1',
                    'patient_stroke_total1',
                    'percentage_total1',
                    'population_total2',
                    'patient_stroke_total2',
                    'percentage_total2',
                    'population_total3',
                    'patient_stroke_total3',
                    'percentage_total3',
                    'population_total4',
                    'patient_stroke_total4',
                    'percentage_total4',
                    'population_total5',
                    'patient_stroke_total5',
                    'percentage_total5'
                )
