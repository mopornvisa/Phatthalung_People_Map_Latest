...
class CopdIncidenceAllExport implements FromView, ShouldAutoSize
{
    ...
    public function view(): View
    {
        ...
        $overallRate = $summary->population_total_sum > 0
            ? ($summary->patient_copd_total_sum / $summary->population_total_sum) * 100
            : 0;
        ...
        return view('exports.copd_incidence_all_excel', compact(
            'rows',
            'year',
            'district',
            'summary',
