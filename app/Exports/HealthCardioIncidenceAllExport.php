...
class HealthCardioIncidenceAllExport implements FromView, ShouldAutoSize
{
    ...
    public function view(): View
    {
        ...
        $summary = (object) [
            ...
            'patient_cardio_total_sum' => (float) $rows->sum('patient_cardio_total'),
        ];
